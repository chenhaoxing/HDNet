...
def load_network(cfg):
    ...
    load_path = os.path.join(cfg.checkpoints_dir, cfg.name, '41_net_G.pth')
    print(load_path)
...
if __name__ == '__main__':
    comp_path =  ['examples/4.jpg', 'examples/5.jpg']# ['examples/1.png', 'examples/2.png']
    mask_path = ['examples/4-mask.png', 'examples/5-mask.png']# ['examples/1-mask.png', 'examples/2-mask.png']
    real_path = ['examples/4-gt.jpg', 'examples/5-gt.jpg']# ['examples/1-gt.png', 'examples/2-gt.png']
    ...
    for i in range(len(testdata)):
        ...
        print(img_path)
        save_img(img_path.split('.')[0] + '-results.png', pred_rgb)
